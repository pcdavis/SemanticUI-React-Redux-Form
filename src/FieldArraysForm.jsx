...
import { Grid, Form, TextArea, Label, Input, Button, Dropdown, Segment } from "semantic-ui-react";
...
const FieldArraysForm = props => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <br/>
      <Field name='myTextAreaImport' placeholder='this came from MyTextArea.jsx' component={MyTextArea} />
      <br/>
      <Field name='rawTextArea' placeholder='<TextArea />' component={TextArea} />
      <br/>

      <Field name="dropdownName" component={ renderDrop}
            label="Dropdown Test" options = {bcbas}
      />
